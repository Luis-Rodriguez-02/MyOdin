...
const oldestToYoungest = inventors.sort((firstInventor, secondInventor) => {
...
const yearsLived = inventors.sort((firstInventor, secondInventor) => {
  return firstInventor.passed - firstInventor.year <
...
let de = ["de", "lede", "hi", "dumainde", "foo"];
const listDE = de.filter((boulevard) => {
